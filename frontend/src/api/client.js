...
// DÜZELTME: Hardcoded URL kaldırıldı — .env dosyasından okunuyor
...
export const api = {
  ...
  // Vitals & Trends
  getVitals: (id, type, limit) => axios.get(`${BASE}/dashboard/patients/${id}/vitals`, {
    params: { signal_type: type, limit },
  }),
  getTrends: (id, type, hours) => axios.get(`${BASE}/dashboard/patients/${id}/trends`, {
    params: { signal_type: type, hours },
  }),
  ...
  getSimulationStatus: () => axios.get(`${BASE}/simulation/status`),
